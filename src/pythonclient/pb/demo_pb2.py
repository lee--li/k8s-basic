...
_GOGREETER = _descriptor.ServiceDescriptor(
  name='GoGreeter',
  full_name='pb.GoGreeter',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='SayHello',
    full_name='pb.GoGreeter.SayHello',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_GOGREETER)

DESCRIPTOR.services_by_name['GoGreeter'] = _GOGREETER
